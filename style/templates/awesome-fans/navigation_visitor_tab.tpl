...
<ul class="visitorTabs">
	...
	<li class="navTab account Popup PopupControl PopupClosed {xen:if $tabs.account.selected, 'selected'}">
		...
		<a href="{xen:link account}" class="navLink accountPopup NoPopupGadget" rel="Menu"><strong class="accountUsername faa-parent animated-hover"><i class="fa fa-chevron-down faa-flash"></i> {$visitor.username}</strong>
	...
	<li class="navTab inbox Popup PopupControl PopupClosed{xen:if {$visitor.conversations_unread}, ' unread'}{xen:if $tabs.inbox.selected, ' selected'}">
		...
		<a href="{xen:link conversations}" rel="Menu" class="navLink NoPopupGadget">@fa_inboxicon
			<strong class="itemCount {xen:if {$visitor.conversations_unread}, '', 'Zero'}"
	...
	<li class="navTab alerts Popup PopupControl PopupClosed{xen:if {$visitor.alerts_unread}, ' unread'}">	
		...
		<a href="{xen:link account/alerts}" rel="Menu" class="navLink NoPopupGadget">@fa_alertsicon
			<strong class="itemCount {xen:if {$visitor.alerts_unread}, '', 'Zero'}"
